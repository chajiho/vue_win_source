    ...
    <div class="content_center">
      <div class="exam_main">
        ...
        <div style="margin-bottom: 1rem; border-bottom: 0.05rem solid #eee">
          <span style="font-size: 1rem; color: #555">2024년 1회 </span>
          <span style="font-size: 0.7rem; color: #bbb">고정됨</span>
        </div>
        ...
        <div>
          ...
          <h5
            ...
            "
          >
            <span style="color: cornflowerblue; font-weight: bold; font-size: 1.5rem">14.</span>
            다음은 Python 프로그램에 대한 문제이다. 빨간색 박스로 가려진 '예약어' 를 알맞게
            작성하시오. (단, 첫 번째 라인의 '5 10'은 사용자로 부터 입력받은 값에 해당한다.)
          </h5>
